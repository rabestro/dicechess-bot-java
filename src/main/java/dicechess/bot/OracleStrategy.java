...
/**
 * Strategy implementation using ONNX value model (or fallback engine evaluation)
 ...
 * bits 12-15 = flags. This is different from MicroMove.</p>
 */
public class OracleStrategy implements Strategy {

    private static final Logger logger = LoggerFactory.getLogger(OracleStrategy.class);

    private final OnnxEvaluator evaluator;

    public OracleStrategy(OnnxEvaluator evaluator) {
    ...
    public java.util.List<String> chooseMoves(TurnContext context) {
        ...
        // TurnGenerator returns List[List[Move]] (not MicroMove!)
    ...
    static String moveToNotation(int move) {
        ...
        String promStr = "";
        if ((flags & 8) != 0) {
            // Knight=8/12, Bishop=9/13, Rook=10/14, Queen=11/15
